...
if($_GET){
    if(isset($_GET['sub'])){
        ...
        // print_r($productObject);die;
        $productResult = $productObject->getPoductsBySub();
                ...
                <div class="grid-list-product-wrapper">
                    <div class="product-grid product-view pb-20">
                        <div class="row">
                            <?php
                            if ($productResult) {
                                $productsFinalResult = $productResult->fetch_all(MYSQLI_ASSOC);
                                foreach ($productsFinalResult as $index => $product) { ?>
                            ...
                            <?php
                                ...
                                echo "<div class='alert alert-danger text-center w-100' > No products yet </div>";
                            }
                    ...
                    <div class="shop-widget">
                        ...
                        <div class="shop-catigory">
                            <ul id="faq">
                                ...
                                ?>
                                <li>
                                    <a data-toggle="collapse" data-parent="#faq" href="#shop-catigory-<?= $key ?>"><?= $category['name_en']?> <i class="ion-ios-arrow-down"></i></a>
                                    <ul id="shop-catigory-<?= $key ?>" class="panel-collapse collapse">
                                        <?php
                                                $subcategoryObject->setCategory_id($category['id']);
                                                $subcategoryFinalResult = $subcategoryObject->getSubsByCats();
                                                //  print_r($subcategoryFinalResult);die;
                                                if ($subcategoryFinalResult) {
                                                    $subcategories = $subcategoryFinalResult->fetch_all(MYSQLI_ASSOC); //  assocعشان التصنيف يرجع ك اوبجيكت
