...
$categoryFinalResult = $categoryObject->read();
// print_r($categoryFinalResult);die;
// ------------------END------------------------
                    ...
                    <div class="header-bottom-right">
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                        <ul class="mega-menu">
                                            <?php
                                            if ($categoryFinalResult) {
                                                $categories = $categoryFinalResult->fetch_all(MYSQLI_ASSOC); // عشان التصنيف يرجع ك اوبجيكت
                                                // print_r($categories);
                                                    ...
                                                    <li>
                                                        <ul>
                                                            ...
                                                            if ($subcategoryFinalResult) {
                                                                $subcategories = $subcategoryFinalResult->fetch_all(MYSQLI_ASSOC); // عشان التصنيف يرجع ك اوبجيكت
                        ...
                        <div class="header-currency">
                            ...
                            <?php
                                ...
                                <span class="digit">Acocunt <i class="ti-angle-down"></i></span>
                                <div class="dollar-submenu">
                                    <ul>
