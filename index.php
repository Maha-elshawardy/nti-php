...
$productNewResult = $productObject->getNewProducts();
$productMostRatedResult = $productObject->getMostRatedProducts();
// get most order------------------------------------------
$productMostOrderResult= $productObject->getOrderProducts();
?>
        ...
        <div class="tab-content jump">
            <div class="tab-pane active">
                <div class="featured-product-active owl-carousel product-nav">
                        ...
                        <?php
                        if ($productNewResult) {
                            $productsFinalResult = $productNewResult->fetch_all(MYSQLI_ASSOC);
        ...
        <div class="tab-content jump">
            <div class="tab-pane active">
                <div class="featured-product-active owl-carousel product-nav">
                        ...
                        <?php
                        if ($productMostRatedResult) {
                            $productsFinalResult = $productMostRatedResult->fetch_all(MYSQLI_ASSOC);
                            foreach ($productsFinalResult as $index => $product) { ?>
                            <div class="product-wrapper mb-30">
                            <div class="product-img">
                                <a href="product-details.php?id=<?=$product['id']?>">
...
<!-- most order Products Start -->
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        <div class="product-top-bar section-border mb-55">
            <div class="section-title-wrap text-center">
                <h3 class="section-title">Most Order Products</h3>
            </div>
        </div>
        <div class="tab-content jump">
            <div class="tab-pane active">
                <div class="featured-product-active owl-carousel product-nav">
                        ...
                        <?php
                        if ($productMostOrderResult) {
                            $productsFinalResult = $productMostOrderResult->fetch_all(MYSQLI_ASSOC);
                            foreach ($productsFinalResult as $index => $product) { ?>
                            <div class="product-wrapper mb-30">
                            <div class="product-img">
                                <a href="product-details.php?id=<?=$product['id']?>">
                            ...
                            <div class="product-content text-left">
                                ...
                                <div class="product-price-wrapper">
                                    <span><?= $product['products_price']?> EGP</span>
                                </div>
                            </div>
                        </div>
